...
namespace dogadjaj_ba.Services.Migrations
{
    ...
    [Migration("20250213144501_pokusajv3")]
    partial class pokusajv3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Notiffication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(497),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(526),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(528),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PaymentId = 1,
                            PaymentDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(538),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 2,
                            PaymentDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(541),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 3,
                            PaymentDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(543),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PublishDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(602),
                        ...
                        {
                            Id = 2,
                            PublishDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(604),
                        ...
                        {
                            Id = 3,
                            PublishDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(605),
                        ...
                        {
                            Id = 4,
                            PublishDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(606),
                        ...
                        {
                            Id = 6,
                            PublishDate = new DateTime(2025, 2, 13, 15, 45, 1, 485, DateTimeKind.Local).AddTicks(607),
