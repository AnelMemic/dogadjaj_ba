...
namespace dogadjaj_ba.Services.Migrations
{
    ...
    [Migration("20250213184313_AddedReccomended1")]
    partial class AddedReccomended1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Notiffication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3425),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3455),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3457),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PaymentId = 1,
                            PaymentDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3467),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 2,
                            PaymentDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3470),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 3,
                            PaymentDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3472),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PublishDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3535),
                        ...
                        {
                            Id = 2,
                            PublishDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3536),
                        ...
                        {
                            Id = 3,
                            PublishDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3538),
                        ...
                        {
                            Id = 4,
                            PublishDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3539),
                        ...
                        {
                            Id = 6,
                            PublishDate = new DateTime(2025, 2, 13, 19, 43, 13, 482, DateTimeKind.Local).AddTicks(3540),
