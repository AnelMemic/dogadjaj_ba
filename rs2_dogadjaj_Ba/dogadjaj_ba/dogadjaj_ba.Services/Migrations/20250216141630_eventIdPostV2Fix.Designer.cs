...
namespace dogadjaj_ba.Services.Migrations
{
    ...
    [Migration("20250216141630_eventIdPostV2Fix")]
    partial class eventIdPostV2Fix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Notiffication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8383),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8414),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            Deleted = false,
                            Read = false,
                            SendOnDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8416),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PaymentId = 1,
                            PaymentDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8425),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 2,
                            PaymentDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8427),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        },
                        new
                        {
                            PaymentId = 3,
                            PaymentDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8429),
                            PaymentMethod = "card",
                            PaymentStatus = "true"
                        });
                });
            ...
            modelBuilder.Entity("dogadjaj_ba.Services.Database.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PublishDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8461),
                        ...
                        {
                            Id = 2,
                            PublishDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8462),
                        ...
                        {
                            Id = 3,
                            PublishDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8464),
                        ...
                        {
                            Id = 4,
                            PublishDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8465),
                        ...
                        {
                            Id = 6,
                            PublishDate = new DateTime(2025, 2, 16, 15, 16, 30, 633, DateTimeKind.Local).AddTicks(8466),
